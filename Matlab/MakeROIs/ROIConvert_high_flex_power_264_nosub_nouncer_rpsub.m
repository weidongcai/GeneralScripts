...
highFlexIdxFname = sprintf('%sROI_idx_high_flex_power_264_nosub_nouncer_rpsub.txt', highFlexIdxFolder);
...
outputFname = sprintf('%spower_264_nosub_nouncer_rpsub_highflex.nii', outputFolder);
